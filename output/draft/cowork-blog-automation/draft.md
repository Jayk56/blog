...
{{< figure src="elevenlabs-pricing.png" alt="ElevenLabs developer analytics dashboard showing 28 minutes of transcription across 11 API requests for a total cost of $0.16" class="mx-auto" >}}
...
{{< figure src="screenshot-12.png" alt="Anthropic blog post introducing Cowork: Claude Code for the rest of your work" class="mx-auto" >}}
