...
export interface ProjectState {
  ...
  /**
   * Whether the current briefing was generated by LLM or template.
   * Used by recomputeDerived to avoid overwriting LLM briefings.
   */
  briefingSource: 'template' | 'llm';
}
...
/** Set LLM-generated briefing content. */
export interface SetLlmBriefingAction {
  type: 'set-llm-briefing';
  briefing: string;
}

/** Reset briefing back to template-generated. */
export interface ResetBriefingAction {
  type: 'reset-briefing';
}
